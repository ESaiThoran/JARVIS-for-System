...
def check_inputs():
    ...
    while True:
        ...
        if input_text != output_text:
            ...
            if output_text.startswith("tell me") or output_text.startswith("remind me"):
            ...
            #elif "check weather" in output_text or "what is weather" in output_text or "how was the climate" in output_text:
             #   text = output_text.replace("check weather in","")
             #   ans = get_weather_by_address(text)
             #   speak(ans)

            elif "check weather" in output_text or "what is weather" in output_text or "how was the climate" in output_text:
                text = output_text.replace("check weather in", "").replace("what is weather in", "").replace("how was the climate in", "").strip()
                if text:
                   ans = get_weather_by_address(text)
                   speak(ans)
                else:
                   speak("Please specify a location to check the weather.")
