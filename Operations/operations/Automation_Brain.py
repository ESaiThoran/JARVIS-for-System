...
def Auto_main_brain(text):
   try: 
    if text.startswith("open"):
        ...
        close()
    elif "play music" in text or "play music on youtube" in text or "song in youtube" in text:
    ...
    elif "check battery percentage" in text or "check battery level" in text or "what is my battery percentage" in text or "what is my battery level" in text:
        check_percentage()
        ...
        time.sleep(0.5)
        gui.press("enter")
    elif "search in google" in text or "search about" in text :
